...
exports.noregis = () => {
	return`*「 BELUM DAFTAR 」*\n\n*cara daftar ${prefix}daftar nama|umur* \n*contoh ${prefix}daftar kaneki|17*`
}
...
${a}❏GROUP MENU${a}
 ...
 ${a}│•${prefix}tagall${a}
 ${a}│•${prefix}setpp${a}
 ${a}│•${prefix}admevent [1/0]${a}
 ${a}│•${prefix}wait${a}
 ${a}│•${prefix}ownergrup${a}
 ${a}│•${prefix}fitnah  <tag>|<text>|<text>${a}
 ${a}│•${prefixtagme${a}
 ${a}│•${prefix}add${a}
 ${a}│•${prefix}kick${a}
 ${a}│•${prefix}setname${a}
...
${a}❏OWNER MENU${a}
 ${a}│•${prefix}ohidetag${a}
 ${a}│•${prefix}owelcome [enable/disable]${a}
 ${a}│•${prefix}oadd <nomor>${a}
 ${a}│•${prefix}okick <tag>${a}
 ${a}│•${prefix}otagall${a}
 ${a}│•${prefix}odemote${a}
 ${a}│•${prefix}onsfw [1/0]${a}
 ${a}│•${prefix}oleveling[enable/disable]${a}
 ${a}│•${prefix}bc${a}
