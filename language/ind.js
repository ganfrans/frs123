exports.wait = () => {
	return`*「 WAIT 」 MIMIN Sedang Dalam proses*`
}
...
exports.noregis = () => {
	return`*「 BELUM DAFTAR 」*\n\n*cara daftar ${prefix}daftar user name|password* \n*contoh ${prefix}daftar FRS|17*`
}

exports.rediregis = () => {
	return`*「 SUDAH TERDAFTAR 」*\n\n*kamu sudah daftar di database bot*`
}
...
exports.registered = (namaUser, umurUser, serialUser, time, sender) => {
	return`*「 DATA AKUN 」*\n\nkamu sudah berhasil login dengan data \n\n┏━➥user name\n┗➥${namaUser}\n┏━➥nomer\n┗➥wa.me/${sender.split("@")[0]}\n┏━➥password\n┗➥${umurUser}\n┏━➥trakhir login\n┗➥${time}\n\n┏━❉ *ID* ❉━\n┣➥${serialUser}\n┗➥NOTE : jangan sampai lupa id kamu karena akan di butuh kan suatuatu`
}
